...
var Instrument = function () {
    function Instrument(options) {
        ...
        if (options.pitch && !options.frequency) {
            this.instrumentOption.frequency = frequencyParam[options.pitch] || 0;
        }
    }
    ...
    createClass(Instrument, [{
        ...
        value: function linearRampToValueAtTime(duringTime) {
        ...
        value: function play(opt) {
            ...
            var playOptions = Object.assign({}, this.instrumentOption, opt);

            if (playOptions.pitch && !playOptions.frequency) {
                playOptions.frequency = frequencyParam[playOptions.pitch] || 0;
            }
